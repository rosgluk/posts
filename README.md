...
- [NVIDIA DGX Spark vs Mac Studio vs RTX-4080: Ollama Performance Comparison](https://www.glukhov.org/post/2025/10/vs-code-dev-containers/ "Real-world Ollama performance comparison running GPT-OSS 120b (a 117B parameter MoE model with 5.1B active parameters) across NVIDIA DGX Spark, Mac Studio, and RTX 4080. Detailed benchmarks show prompt evaluation, token generation rates, and CPU/GPU offloading behavior for this 65GB model.")
